var OneTrustStub = ((t) => {
            ...
            (this.LOCATOR_NAME = "__gppLocator"),
                ...
                (this.addFrame = function (t) {
                    ...
                    return (
                        n ||
                            (i.body
                                ? (((e = i.createElement("iframe")).style.cssText = "display:none"), (e.name = t), e.setAttribute("title", "GPP Locator"), i.body.appendChild(e))
                                : setTimeout(function () {
                                      s.addFrame(t);
                                  }, 5)),
                        !n
    ...
    (f.prototype.initConsentSDK = function () {
        ...
        (f.prototype.setDomainIfBulkDomainEnabled = function (t) {
            ...
            e &&
                ...
                ((e = window.sessionStorage) && e.getItem("bulkDomainMgmtEnabled")
                    ...
                    : ((n = { location: l.storageBaseURL.replace(/^https?:\/\//, ""), domainId: this.domainId, url: i }), this.otFetch(a, this.handleBulkDomainMgmt, !1, n, t)));
        }),
        (f.prototype.getLocation = function (t) {
            if (
                (this.setDomainIfBulkDomainEnabled(t),
                this.updateVersion(t),
                ((t.TenantFeatures && t.TenantFeatures.CookieV2CSP) || t.CookieV2CSPEnabled) && this.nonce && ((this.setAttributePolyfillIsActive = !0), new n().implementThePolyfill()),
                h.checkAndAssignCspTrustedTypeEnabled(t) && h.initCSPTrustedType(l.storageBaseURL),
                !t.RuleSet[0].Type)
            )
                return (this.iabTypeAdded = !1), (window.__tcfapi = this.executeTcfApi), this.intializeIabStub(), this.addBannerSDKScript(t);
            var e,
                i = window;
            i.OneTrust && i.OneTrust.geolocationResponse
                ? ((i = i.OneTrust.geolocationResponse), this.setGeoLocation(i.countryCode, i.stateCode, i.stateName), this.addBannerSDKScript(t))
                : (i = this.readCookieParam(l.optanonCookieName, l.geolocationCookiesParam)) || t.SkipGeolocation
        ...
        (f.prototype.setOTDataLayer = function () {
            ...
            this.otDataLayer = { ignore: (e && "true" === t) || (e && "" === t), name: l.stubScriptElement.getAttribute("data-dLayer-name") || "dataLayer" };
        }),
        (f.prototype.setGeoLocation = function (t, e, i) {
            l.userLocation = { country: t, state: (e = void 0 === e ? "" : e), stateName: (i = void 0 === i ? "" : i) };
        }),
                ...
                s =
                    (this.otDataLayer.ignore || void 0 === o[this.otDataLayer.name]
                        ...
                        : o[this.otDataLayer.name].constructor === Array &&
                          (o[this.otDataLayer.name].push({ event: "OneTrustLoaded", OnetrustActiveGroups: a }), o[this.otDataLayer.name].push({ event: "OptanonLoaded", OptanonActiveGroups: a })),
                    new CustomEvent("consent.onetrust", { detail: t }));
            !this.otDataLayer.ignore &&
                t.length &&
                (o[this.otDataLayer.name].constructor === Array && o[this.otDataLayer.name].push({ event: "OneTrustGroupsUpdated", OnetrustActiveGroups: a }), (n = new CustomEvent("OneTrustGroupsUpdated", { detail: t }))),
                setTimeout(function () {
        ...
        (f.prototype.setStubScriptElement = function () {
            ...
            l.stubScriptElement && l.stubScriptElement.hasAttribute(l.DATAFILEATTRIBUTE)
                ...
                : t
                ? (this.domainId = t)
                : l.stubScriptElement || ((l.stubScriptElement = document.querySelector("script[src*='" + l.migratedCCTID + "']")), l.stubScriptElement && ((l.isMigratedURL = !0), (this.domainId = l.migratedDomainId.trim())));
        }),
        ...
        (f.prototype.setGeoParam = function (t) {
            var e;
            t && ((e = window).OneTrust || (e.OneTrust = {}), (t = t.split(",")), (e.OneTrust.geolocationResponse = { countryCode: t[0], stateCode: t[1] }));
        }),
    ...
    function f() {
        ...
        (this.iabType = null),
            ...
            (this.addBannerSDKScript = function (t) {
                var e = s.getRegionSet(t),
                    i =
                        ...
                        s.iabTypeAdded && (("IAB2" !== e.Type && "IAB2V2" !== e.Type) || ((s.iabType = e.Type), s.intializeIabStub()), "IAB2" !== e.Type) && "IAB2V2" !== e.Type && s.removeTcf(),
                        e.IsGPPEnabled ? m.init() : m.removeGppApi(),
                        l.stubScriptElement.cloneNode(!0)),
                    n = "",
                    n = t.UseSDKRefactor
                        ? (l.isMigratedURL && (i.src = l.storageBaseURL + "/scripttemplates/new/scripttemplates/" + l.stubFileName + ".js"),
                          l.storageBaseURL + "/scripttemplates/new/scripttemplates/" + t.Version.replaceAll(".", "_") + "/" + l.bannerScriptName + "?v=20250516.6")
                        : "5.11.0" === t.Version
                        ? (l.isMigratedURL && (i.src = l.storageBaseURL + "/scripttemplates/old/scripttemplates/" + l.stubFileName + ".js"), l.storageBaseURL + "/scripttemplates/old/scripttemplates/5.11.0/" + l.bannerScriptName)
                        : (l.isMigratedURL && (i.src = l.storageBaseURL + "/scripttemplates/" + l.stubFileName + ".js"), l.storageBaseURL + "/scripttemplates/" + t.Version.replaceAll(".", "_") + "/" + l.bannerScriptName + "?v=20250516.6");
            ...
            (this.intializeIabStub = function () {
                var t = window;
                s.iabTypeAdded ? (void 0 === t.__tcfapi && (window.__tcfapi = s.executeTcfApi), s.addIabFrame()) : s.addBackwardIabFrame(),
            ...
            (this.getPingRequest = function (t, e) {
                ...
                t &&
                    ...
                    ("IAB2" !== s.iabType && "IAB2V2" !== s.iabType) ||
                        ((i = { gdprApplies: l.oneTrustIABgdprAppliesGlobally, cmpLoaded: !1, cmpStatus: "stub", displayStatus: "stub", apiVersion: "2.0", cmpVersion: void 0, cmpId: void 0, gvlVersion: void 0, tcfPolicyVersion: void 0 }),
                        (n = !0)),
                    t(i, n));
            }),
            (this.getConsentDataRequest = function (t) {
                t && l.IABCookieValue && t({ gdprApplies: l.oneTrustIABgdprAppliesGlobally, hasGlobalScope: l.hasIABGlobalScope, consentData: l.IABCookieValue }, !0);
            }),
            this.initConsentSDK();
    }
    var E = new A();
    return (t.OtSDKStub = A), (t.otSdkStub = E), Object.defineProperty(t, "__esModule", { value: !0 }), t;
})({});
